...
from dataset.dataloader import SalObjDatasetRGB
...
#     image_root = ''
#     if option['task'] == 'COD':
#         image_root = option['paths']['test_dataset_root'] + dataset + '/Imgs/'
#         test_loader = test_dataset(image_root, option['testsize'])
#     elif option['task'] == 'SOD':
#         image_root = option['paths']['test_dataset_root'] + '/Imgs/' + dataset + '/'
#         test_loader = test_dataset(image_root, option['testsize'])
#     elif option['task'] == 'Weak-RGB-SOD':
#         image_root = option['paths']['test_dataset_root'] + '/Imgs/' + dataset + '/'
#         test_loader = test_dataset(image_root, option['testsize'])
#     elif option['task'] == 'RGBD-SOD':
#         image_root = option['paths']['test_dataset_root'] + dataset + '/RGB/'
#         depth_root = option['paths']['test_dataset_root'] + dataset + '/depth/'
...
#             start = time.time()
#             z_noise = torch.randn(image.shape[0], 32).cuda()
#             res = generator.forward(img=image, z=z_noise)
#         elif option['task'] == 'RGBD-SOD':
